...
def display_results(data):
    ...
    ci = calculate_consistency(comparison_matrix)  # Use the provided comparison_matrix
    ...
    if cr < 0.10:
        st.write("Consistency Ratio (CR) is acceptable.")
    else:
        st.write("Consistency Ratio (CR) is not acceptable.")
